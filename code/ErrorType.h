...
enum class ErrorType {
    ...
    UNDEFINED_VARIABLE, INCORRECT_ARGS_COUNT, VARIABLE_REDEFINITION, DIVISION_BY_ZERO, EMPTY_VALUE, UNKNOWN_IDENTIFIER,
    IDENTIFIER_REDEFINITION, INVALID_CONVERSION, OUT_OF_RANGE, REASSIGN_IMMUTABLE_VARIABLE,
